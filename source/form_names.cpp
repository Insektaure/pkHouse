...
static const uint16_t ALOLAN[] = {19,20,26,27,28,37,38,50,51,52,53,74,75,76,88,89,103,104,105};
static const uint16_t GALARIAN[] = {77,78,79,80,83,109,122,144,145,146,199,222,263,264,554,555,562,618};
